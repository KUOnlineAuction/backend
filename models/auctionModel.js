...
const productDetailSchema = new mongoose.Schema({
  productName: {
    ...
    maxlength: [
      ...
      `The name cannot exceed ${productNameMaxLength}.`,
    ],
  },
  category: {
    type: String,
  ...
  description: {
    ...
    maxlength: [
      productDesciptionMaxLength,
      `The description cannot exceed ${productDesciptionMaxLength}.`,
    ],
  },
  productPicture: {
    type: [String],
...
const auctionSchema = new mongoose.Schema({
  productDetail: {
    ...
    required: [
      true,
      "An auction must have the complete detail of the products.",
    ],
  },
  auctioneerID: {
    ...
    validate: {
      validator: function (el) {
        ...
        if (!this.currentPrice) {
          return el >= this.currentPrice;
        }
        // if there was already a bid
        const bidstep =
          this.minimumBidPrice | defaultMinimumBid(this.currentPrice);
...
//For First Create Auction and setting CurrentPrice
